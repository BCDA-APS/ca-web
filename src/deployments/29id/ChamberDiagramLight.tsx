...
export function ChamberDiagramLight() {
  // Pressure
  ...
  return (
    <div style={{ background: "rgb(222,222,227)", borderRadius: 6, padding: 10, display: "inline-block" }}>
      <svg width={452} height={350} viewBox="40 0 452 350" style={{ display: "block" }}>
        <defs>
          <marker id="cdl-w" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
            <polygon points="0,0 8,3 0,6" fill="#1565c0" />
          </marker>
          <marker id="cdl-r" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
            <polygon points="0,0 8,3 0,6" fill="#ef5350" />
          </marker>
          <marker id="cdl-g" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
            <polygon points="0,0 8,3 0,6" fill="#66bb6a" />
          </marker>
          <marker id="cdl-o" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
        ...
        <path d="M 95,125 A 80,80 0 0 1 148,50"
          stroke="#1565c0" strokeWidth="1.5" fill="none" markerEnd="url(#cdl-w)" />
        ...
        <line x1={sx + 11} y1={sy} x2={sx + 78} y2={sy}
          stroke="#66bb6a" strokeWidth="2" markerEnd="url(#cdl-g)" />
        ...
        <line x1={sx} y1={sy + 7} x2={sx} y2={sy + 78}
          stroke="#ef5350" strokeWidth="2" markerEnd="url(#cdl-r)" />
        ...
        <line x1="303" y1="216" x2={sx + 16} y2={sy + 13}
          stroke="#ffa726" strokeWidth="2" markerEnd="url(#cdl-o)" />
        ...
        {/* ── Chi / Phi ── */}
        <text x="347" y="14" fill="#333333" fontSize="12" fontFamily="sans-serif" fontStyle="italic">chi:</text>
        <text x="374" y="14" fill="#666666" fontSize="12" fontFamily="sans-serif">flip along slit</text>

        <text x="347" y="30" fill="#333333" fontSize="12" fontFamily="sans-serif" fontStyle="italic">phi:</text>
        <text x="374" y="30" fill="#666666" fontSize="12" fontFamily="sans-serif">azimuth</text>
        <text x="347" y="44" fill="#666666" fontSize="12" fontFamily="sans-serif">about normal</text>

        {/* ── Pressure ── */}
        <line x1="338" y1="62" x2="478" y2="62" stroke="#1e3a5c" strokeWidth="1" />
        <text x="347" y="76" fill="#7c6fa0" fontSize="12" fontFamily="sans-serif"
        ...
        <g onClick={() => openStripChart("29idc:VS11C.VAL", "VS11C trend")} style={{ cursor: "pointer" }}>
          <rect x="344" y="84" width="58" height="15" rx="3"
            fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="373" y="94" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11"
        ...
        <text x="476" y="94" fill="#444444" fontSize="10" fontFamily="sans-serif">T</text>

        <g onClick={() => openStripChart("29idc:IP11C1.VAL", "IP11C1 trend")} style={{ cursor: "pointer" }}>
          <rect x="344" y="102" width="58" height="15" rx="3"
            fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="373" y="112" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11"
        ...
        <text x="476" y="112" fill="#444444" fontSize="10" fontFamily="sans-serif">T</text>

        {/* ── Temperature ── */}
        <line x1="338" y1="134" x2="478" y2="134" stroke="#1e3a5c" strokeWidth="1" />
        <text x="347" y="148" fill="#7c6fa0" fontSize="12" fontFamily="sans-serif"
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", {
          ...
          <rect x="464" y="137" width="14" height="14" rx="2" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="471" y="147" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">⚙</text>
        </g>
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", {
          ...
          <rect x="344" y="156" width="58" height="14" rx="3" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="373" y="166" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">Sample</text>
        </g>
        <text x="469" y="166" fill="rgb(10,37,159)" fontSize="12" fontFamily="monospace"
          textAnchor="end" style={{ cursor: "context-menu" }} onContextMenu={e => pvCtx("29idARPES:LS335:TC1:INA", vINA, e)}>{tempA}</text>
        <text x="476" y="166" fill="#444444" fontSize="10" fontFamily="sans-serif">K</text>
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", {
          ...
          <rect x="344" y="174" width="58" height="14" rx="3" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="373" y="184" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">Cold fngr</text>
        </g>
        <text x="469" y="184" fill="rgb(10,37,159)" fontSize="12" fontFamily="monospace"
          textAnchor="end" style={{ cursor: "context-menu" }} onContextMenu={e => pvCtx("29idARPES:LS335:TC1:INB", vINB, e)}>{tempB}</text>
        <text x="476" y="184" fill="#444444" fontSize="10" fontFamily="sans-serif">K</text>

        {/* Setpoint */}
        <text x="347" y="206" fill="#333333" fontSize="11" fontFamily="sans-serif">Setpoint</text>
        {editingSP ? (
        ...
        <text x="476" y="206" fill="#444444" fontSize="10" fontFamily="sans-serif">K</text>

        {/* Power */}
        <text x="347" y="222" fill="#333333" fontSize="11" fontFamily="sans-serif">Power</text>
        <text x="469" y="222" fill="rgb(10,37,159)" fontSize="12" fontFamily="monospace"
          textAnchor="end" style={{ cursor: "context-menu" }} onContextMenu={e => pvCtx("29idARPES:LS335:TC1:HTR1", vHTR, e)}>{power}</text>
        <text x="476" y="222" fill="#444444" fontSize="10" fontFamily="sans-serif">%</text>

        {/* Heater range — dropdown */}
        <text x="347" y="238" fill="#333333" fontSize="11" fontFamily="sans-serif">Heater</text>
        <foreignObject x="400" y="228" width="78" height="17">
          <select
            ...
            style={{
              width: "100%", height: "100%", boxSizing: "border-box",
              background: "rgb(210,220,240)", color: heaterColor(htrRange),
              border: "1px solid rgb(160,180,220)", borderRadius: 2,
        ...
        {/* Scan rate — dropdown */}
        <text x="347" y="254" fill="#333333" fontSize="11" fontFamily="sans-serif">Scan</text>
        <foreignObject x="400" y="244" width="78" height="17">
          <select
            ...
            style={{
              width: "100%", height: "100%", boxSizing: "border-box",
              background: "rgb(210,220,240)", color: "rgb(0,53,132)",
              border: "1px solid rgb(160,180,220)", borderRadius: 2,
              fontSize: 12, fontFamily: "sans-serif", cursor: "pointer",
              padding: "0 2px",
            }}
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", { detail: { file: "/ui/29id_scanDet.ui", macros: { P: "29idARPES:", S: "scan1", N: "15" }, label: "D15 Diode" } }))}>
          <rect x="44" y="295" width="34" height="16" rx="3" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="61" y="307" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">[D15]</text>
        </g>
        <text x="80" y="308" fill="#333333" fontSize="11" fontFamily="sans-serif">Diode</text>
        <text x="190" y="308" fill="rgb(10,37,159)" fontSize="12" fontFamily="monospace" textAnchor="end" style={{ cursor: "context-menu" }} onContextMenu={e => pvCtx("29idb:ca15:read", vD15, e)}>{d15}</text>
        <g style={{ cursor: "pointer" }} onClick={() => pvwsWriter.write("29idARPES:userStringSeq7.PROC", 1)}>
          <rect x="196" y="295" width="43" height="16" rx="3" fill="#fff3e0" stroke="#ffa726" strokeWidth="1" />
          <text x="217" y="307" textAnchor="middle" fill="#e65100" fontSize="11" fontFamily="sans-serif">Live</text>
        </g>
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", { detail: { file: "/ui/Keithley6485.ui", macros: { P: "29idb:", CA: "ca15" }, label: "Keithley D15" } }))}>
          <rect x="241" y="295" width="16" height="16" rx="2" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="249" y="307" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">⚙</text>
        </g>
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", { detail: { file: "/ui/29id_scanDet.ui", macros: { P: "29idARPES:", S: "scan1", N: "16" }, label: "D16 TFY" } }))}>
          <rect x="272" y="295" width="34" height="16" rx="3" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="289" y="307" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">[D16]</text>
        </g>
        <text x="308" y="308" fill="#333333" fontSize="11" fontFamily="sans-serif">TFY</text>
        <text x="418" y="308" fill="rgb(10,37,159)" fontSize="12" fontFamily="monospace" textAnchor="end" style={{ cursor: "context-menu" }} onContextMenu={e => pvCtx("29idc:ca2:read", vD16, e)}>{d16}</text>
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", { detail: { file: "/ui/Keithley6485.ui", macros: { P: "29idc:", CA: "ca2" }, label: "Keithley D16" } }))}>
          <rect x="470" y="295" width="16" height="16" rx="2" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="478" y="307" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">⚙</text>
        </g>
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", { detail: { file: "/ui/29id_scanDet.ui", macros: { P: "29idARPES:", S: "scan1", N: "18" }, label: "D18 EA" } }))}>
          <rect x="44" y="322" width="34" height="16" rx="3" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="61" y="334" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">[D18]</text>
        </g>
        <text x="80" y="335" fill="#333333" fontSize="11" fontFamily="sans-serif">EA</text>
        <text x="190" y="335" fill="rgb(10,37,159)" fontSize="12" fontFamily="monospace" textAnchor="end" style={{ cursor: "context-menu" }} onContextMenu={e => pvCtx("29idcScienta:Stats4:Total_RBV", vD18, e)}>{d18}</text>
        <g style={{ cursor: "pointer" }} onClick={() => pvwsWriter.write("29idcScienta:HV:ZeroSuppliesSeq.PROC", 1)}>
          <rect x="196" y="322" width="43" height="16" rx="3" fill="#ffebee" stroke="#ef5350" strokeWidth="1" />
          <text x="217" y="334" textAnchor="middle" fill="#b71c1c" fontSize="11" fontFamily="sans-serif">HV off</text>
        </g>
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", { detail: { file: "/ui/29idc_Scienta.ui", macros: { P: "29idcScienta:" }, label: "Scienta" } }))}>
          <rect x="241" y="322" width="16" height="16" rx="2" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="249" y="334" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">⚙</text>
        </g>
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", { detail: { file: "/ui/29id_scanDet.ui", macros: { P: "29idARPES:", S: "scan1", N: "14" }, label: "D14 TEY" } }))}>
          <rect x="272" y="322" width="34" height="16" rx="3" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="289" y="334" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">[D14]</text>
        </g>
        <text x="308" y="335" fill="#333333" fontSize="11" fontFamily="sans-serif">TEY</text>
        <text x="418" y="335" fill="rgb(10,37,159)" fontSize="12" fontFamily="monospace" textAnchor="end" style={{ cursor: "context-menu" }} onContextMenu={e => pvCtx("29idb:ca14:read", vD14, e)}>{d14}</text>
        ...
        <g style={{ cursor: "pointer" }} onClick={() => window.dispatchEvent(new CustomEvent("open-ui", { detail: { file: "/ui/Keithley6485.ui", macros: { P: "29idb:", CA: "ca14" }, label: "Keithley D14" } }))}>
          <rect x="470" y="322" width="16" height="16" rx="2" fill="rgb(210,220,240)" stroke="rgb(160,180,220)" strokeWidth="1" />
          <text x="478" y="334" textAnchor="middle" fill="rgb(0,53,132)" fontSize="11" fontFamily="sans-serif">⚙</text>
        </g>
      </svg>
    </div>
  );
